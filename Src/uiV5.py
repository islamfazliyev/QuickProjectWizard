...
"font: 16pt \"MS Shell Dlg 2\"; background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.langSelect.setItemText(2, _translate("MainWindow", "C"))
        self.langSelect.setItemText(3, _translate("MainWindow", "C++"))
        self.langSelect.setItemText(4, _translate("MainWindow", "Ruby"))
        self.langSelect.setItemText(5, _translate("MainWindow", "Rust"))
        self.langSelect.setItemText(6, _translate("MainWindow", "Golang"))
        self.langSelect.setItemText(7, _translate("MainWindow", "Lua"))
        self.langSelect.setItemText(8, _translate("MainWindow", "Web"))
